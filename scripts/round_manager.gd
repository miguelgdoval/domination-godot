...
## Discard the indicated hand tiles, consume one discard charge, and
## redraw to refill the hand. Replacements come from a fresh random
## draw — no bias toward tiles that fit the chain. Discarding is a
## tactical reroll, not a guaranteed fishing trip.
##
